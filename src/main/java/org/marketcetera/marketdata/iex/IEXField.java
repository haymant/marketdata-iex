...
/**
 * Represents a field in a IEX market data request. 
 *
...
enum IEXField
{
     ...
     * @return a <code>IEXField</code> value or <code>null</code> if no field corresponds to the given literal
     */
    public static IEXField getFieldFor(String inCode)
    {
        synchronized(fields) {
            if(fields.isEmpty()) {
                for(IEXField field : IEXField.values()) {
    ...
    /**
     * Create a new IEXField instance.
     *
     * @param inCode a <code>IEXField</code> value
     */
    private IEXField(String inCode)
    {
        code = inCode;
    }
    /**
     ...
     */
    private static final Map<String,IEXField> fields = new HashMap<String,IEXField>();
}
